...
const INFO = [
  { icon: Mail, title: "Email Us", value: "support@meridian.com", sub: "We respond within 24 hours" },
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="max-w-xl">
            ...
            <p className="mt-5 max-w-md text-sm leading-relaxed text-muted-foreground md:text-base">
              Have a question, need support, or just want to say hello? Our
              team is ready to help. Send us a message and we&apos;ll get back
          ...
          <div className="relative aspect-[5/4] overflow-hidden rounded-2xl">
            <Image
              src="https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=1200&q=80"
              alt=""
              fill
              sizes="(min-width: 1024px) 50vw, 100vw"
              className="object-cover"
            />
            <div className="pointer-events-none absolute right-5 top-5 max-w-[150px] rounded-lg bg-white/90 px-3 py-2 backdrop-blur-sm">
